...
import static ru.vsu.rogachev.exception.BusinessLogicExceptionType.USER_ALREADY_IN_GAME;
import static ru.vsu.rogachev.exception.BusinessLogicExceptionType.USER_CREATING_THE_GAME;
import static ru.vsu.rogachev.exception.BusinessLogicExceptionType.USER_NOT_CONFIRM_ACCOUNT;
import static ru.vsu.rogachev.exception.BusinessLogicExceptionType.USER_NOT_REGISTERED;
import static ru.vsu.rogachev.exception.BusinessLogicExceptionType.USER_WAITING_CONNECTION_TO_ANOTHER_GAME;
import static ru.vsu.rogachev.handler.BasicStateCommandHandler.ProcessedCommand.AGREE_GAME_COMMAND;
import static ru.vsu.rogachev.handler.BasicStateCommandHandler.ProcessedCommand.REFUSE_GAME_COMMAND;
    ...
    public void execute(@NotNull User user, @NotNull Long chatId, @NotNull String message) {
        ...
        switch (command) {
            case EXIT_COMMAND -> {
                ...
                messageUtils.sendBasicStateMessage(chatId, CANCEL_CHOOSING_OPPONENT_RESULT_TEXT);
            }
            case SELECT_HANDLE_COMMAND -> {
                ...
                try {
                    ...
                    messageUtils.sendMessage(chatId, SENT_INVITE_RESULT_TEXT);
                } catch (Exception e) {
